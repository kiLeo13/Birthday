    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args[0].equalsIgnoreCase("reload")) {
            ...
            if (Birthdays.getInstance().reloadBirthdaysConfig()) {
                sender.sendRichMessage("<dark_gray>[</dark_gray><gold>Birthdays</gold><dark_gray>]</dark_gray> <green>Configuration successfully reloaded!");

                Birthday.getPlugin().reloadConfig();
                sender.sendRichMessage("<dark_gray>[</dark_gray><gold>Configuration</gold><dark_gray>]</dark_gray> <green>Configuration successfully reloaded!");
